...
echo "Введите логин для подключения к серверу $host_back001 "
read -s usr

echo "Введите пароль для подключения к серверу $host_back001 "
read -s pass
...
sudo cp -r /home/ivan/back001.mshome.net/srv/www/wordpress /srv/www;
sudo rm /etc/apache2/sites-available/*
sudo rm /etc/apache2/sites-enabled/*
sudo cp /home/ivan/wordpress.conf /etc/apache2/sites-available/
