...
mysql -e \"ALTER USER 'root'@'localhost' IDENTIFIED WITH 'caching_sha2_password' BY '113525'\"
mysql -u root -p -e \"CREATE DATABASE wp_db\"
mysql -u root -p -e \"CREATE DATABASE wp_db_1\"
mysql -u root -p -e \"CREATE USER wp_user@'%' IDENTIFIED BY '113525'\"
mysql -u root -p -e \"GRANT ALL PRIVILEGES ON wp_db.* TO wp_user@'%'\"
mysql -u root -p -e \"GRANT ALL PRIVILEGES ON wp_db_1.* TO wp_user@'%'\"
mysql -u root -p wp_db < /home/ivan/tmp/backup-20240316115116/wp_db.sql
mysql -u root -p wp_db_1 < /home/ivan/tmp/backup-20240316115116/wp_db_1.sql
"
